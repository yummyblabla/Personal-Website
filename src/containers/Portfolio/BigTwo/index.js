		...
		<Container className="fixFooter">
			<Row>
				...
				<Col sm className="mt-5">
					...
					<p className="mb-3">As a personal project, I wanted to make a game that I knew very well and would enjoy playing online. As a result, I decided to make <a href="https://en.wikipedia.org/wiki/Big_two">Big Two</a>, which is a popular Chinese card game that only requires a deck of regular playing cards.</p>
					...
					<div className="mb-5">
						<p class="mb-0">Card Art belongs to <a href="https://sourceforge.net/projects/vector-cards/">Chris Aguilar</a></p>
					</div>
				</Col>
			</Row>
