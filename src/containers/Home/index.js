				...
				<Container>
					...
					<Row>
						<Col sm className="item">
							<h3 className="text-center mt-3 mb-3">Techologies I Use</h3>
						...
						<Col sm className="item">
							...
							<ul className="mb-3">
								...
								<li>Communicated effectively with managers and QA team to ensure all features and scope of project were met</li>
							...
							<ul className="mb-3">
								...
								<li>Developed an English instruction manual for future interns on how to use software automation</li>
